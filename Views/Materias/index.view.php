                ...
                <div class="col-md-12">
                    ...
                    <table id="ListaMaterias" class="table table-sm table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <?php
                            foreach ($materiasDB as $materia) { ?>
                                <tr>
                                    <td><?= $materia->id; ?></td>
                                    <td><?= $materia->nombre; ?></td>
                                    <td>
                                        <div class="btn-group">
                                            <a href="updateMaterias.php?id=<?= $materia->id; ?>" class="btn btn-warning btn-sm">Editar</a>
                                            <a href="deleteMaterias.php?id=<?= $materia->id; ?>" class="btn btn-danger btn-sm">Eliminar</a>
                                        </div>
                                    </td>
                                </tr>
